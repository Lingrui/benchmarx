...
eval_bin = os.path.abspath(os.path.join(ROOT, '../3rd/kitti_native_evaluation/evaluate_object_3d_offline'))

gt_dir = os.path.abspath(os.path.join(ROOT, '../data/kitti/training/label_2'))
